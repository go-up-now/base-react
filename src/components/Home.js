    ...
    return (
        <>
            <div>Yêu cầu: <br />
                ...
                Sử dụng thư viện React để tạo một màn hình website cơ bản bao gồm các chức năng: <br />
            </div>
            <ul>
                <li>1. Đăng nhập</li>
                <li>2. Thêm User</li>
            ...
            <div>
                Tự do tùy chỉnh html, css, để có một website nhẹ nhàng, khoa học và đẹp. <br />
                Commit và đẩy source code lên github public. <br />
                Triển khai website lên Heroku để demo. <br />
            </div>
            <div>
                Result: Thời gian hoàn thành: 1 - 3 ngày <br />
                Gửi link Heroku và Github link lại email này <br />
                Thời gian phản hồi 2 ngày làm việc kể từ ngày nhận được bài thi. <br />
                Yêu cầu backend(optional - không bắt buộc): <br />
                Sử dụng python django rest framework, tạo các api như trên trang web: https://reqres.in/ <br />
            </div>
        </>
    )
}
